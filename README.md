...
Created and maintained with ❤️ by [Ratau Micek](https://twitter.com/rataumicek).

## Live demo

Check the live demo here 👉️ [https://www.noiseeveryday.xyz/](https://noiseeveryday.xyz/)
...
- [Noise Everyday NFT](https://opensea.io/collection/noise-everyday)

## Terms and License

- Released under the [GPL](https://www.gnu.org/licenses/gpl-3.0.html).
- Copyright 2022 [Ratau Micek](https://twitter.com/rataumicek).
- Use it for personal and commercial projects, but please don’t republish, redistribute, or sell the template.
- Attribution is not required, although it is really appreciated.

## About Us

We're an Indonesian developer/designer duo creating high-quality design/code resources for developers, makers, and startups.

## Stay in the loop

If you would like to know when we release new resources, you can follow us on [Twitter](https://twitter.com/rataumicek).